...
<span id="error">
 ...
 ?>  > <span>District here</span></span>
		</div>
	</div>

	<div class="w3ls-list">
		<div class="container">
		<h2>District Matrimonial Profiles list</h2>
...
$sql = "SELECT * FROM user where gender!='$_SESSION[gender]'AND district='$district' AND pay_status='1' ";
$result = $conn->query($sql);
...
{
 $sql = "SELECT * FROM user where gender!='$_SESSION[gender]'AND district='$district' ";
$result = $conn->query($sql);
