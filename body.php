...
<span id="error">
 ...
 ?>  > <span>Body Type here</span></span>
		</div>
	</div>

	<div class="w3ls-list">
		<div class="container">
		<h2>Body Type Matrimonial Profiles list</h2>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
$sql = "SELECT * FROM user where gender!='$_SESSION[gender]'AND body='$body' AND pay_status='1' ";
$result = $conn->query($sql);
