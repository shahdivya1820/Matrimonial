...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
$sql = "SELECT * FROM user where gender!='$_SESSION[gender]'AND city='$city' AND pay_status='1' ";
$result = $conn->query($sql);
...
{
   $sql = "SELECT * FROM user where gender!='$_SESSION[gender]'AND city='$city' ";
$result = $conn->query($sql);
